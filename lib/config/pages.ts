...
export const studySubPages: StudyPageDef[] = [
    ...
    {
        segment: "expression-studio",
        labelKey: "expressionStudio",
        descriptionKey: "expressionStudioDescription",
        icon: Blocks,
        navSection: "config",
        access: currentStudyActionsAccess([StudyAction.updateStudyRules]),
    },
