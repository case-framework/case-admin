...
2. Select the option **"Q"uestion or Info item"**.
...
5. Write your question in the text field of the title component. Add addtional information in the text field of the subtitle. Write optional text before or after response options in top and bottom content components.
...
11. Enter option label text for different languages by switching the language tabs above the options list. This ensures participants see the options in their selected language.
