...
### 📝 Survey Item List
- **Items**: This section lists all the [items](/docs/survey-editor/basics/item-structure#survey-item-structure-and-functions) of the survey. Each item has:
