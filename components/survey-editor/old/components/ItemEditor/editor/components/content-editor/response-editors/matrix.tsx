import { ItemComponentRole } from "@/components/survey-editor/old/components/types";
import { getLocalizedString } from '@/utils/localizedStrings';
import { getUniqueRandomKey } from "@/components/survey-editor/old/utils/new-item-init";
