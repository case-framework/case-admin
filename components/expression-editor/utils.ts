...
export type IconVariant = 'braces' | 'function' | 'code' | 'box' | 'variable' | 'brackets' | 'regex' | 'square-code' | 'terminal' | 'signpost' | 'layout-list' |
    ...
    'file-plus' | 'file-x' | 'file-pen' | 'file-key' | 'sigma' | 'dice' | 'minus' | 'clock' | 'hourglass' | 'key-round' | 'circle-question-mark' | 'mail-question-mark' | 'app-window' | 'package' | 'package-search' |
